...
public class AnalyzeTargetTask extends AbstractTask {
     ...
     * @param listener    The result listener to be informed when the destination is
     *                    reached. / public AnalyzeTargetTask(ISpaceObject target,
     *                    IResultListener listener) { super(listener); this.target =
     *                    target; this.time = TIME; }
     */

    // -------- AbstractTask methods --------

    /**
     * This method will be executed by the object before the task gets added to the
     * execution queue.
     * 
