...
@Service
@Plans({ @Plan(trigger = @Trigger(goals = SpyAgent.AnalyzeTarget.class), body = @Body(AnalyzeTargetPlan.class)) })
...
public class SpyAgent extends BaseMobileAgent implements ITargetAnnouncementService {
    /**
     * 
     */
...
//      System.out.println("Sentry was informed about new target: "+target);
    ...
    public static class AnalyzeTarget {
         ...
         */
        public AnalyzeTarget(SpyAgent outer, ISpaceObject target) {
        ...
        public static AnalyzeTarget checkCreate(SpyAgent outer, ISpaceObject target, ChangeEvent event) {
